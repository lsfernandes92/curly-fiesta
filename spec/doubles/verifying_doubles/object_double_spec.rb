# object_double can be used to create a double from an existing
# “template” object, from which it verifies that any stubbed methods on the
# double also exist on the template. This is useful for objects that are readily
...
# 
# In addition, object_double can be used with specific constant values, as shown
# below. This is for niche situations, such as when dealing with singleton objects.
